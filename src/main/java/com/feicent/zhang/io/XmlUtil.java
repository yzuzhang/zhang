...
public class XmlUtil {
    ...
    public static String toString(Document doc, String encoding) throws Exception {
        OutputFormat format = OutputFormat.createPrettyPrint();
        format.setEncoding(encoding);
        ByteArrayOutputStream byteOS = new ByteArrayOutputStream(); //写到内存里
    ...
    public static void main(String[] args) throws Exception {
    	...
    	File inputXml = new File("D:/TCPGetChatInfo.jmx");
    	modifyDocument(inputXml, "CSVDataSet", "filename", "customer_pins.txt", "D:/TCPGetChatInfo2.jmx");
    }
}
