 ...
 * 原文 https://www.cnblogs.com/alwu007/p/8111581.html
 */
public class EncodeFileUtil {
    ...
    public EncodeFileUtil(boolean isEncode, String filename, String key) {
    ...
    public static void main(String[] args) {
    	...
    	String filename = "D:/zhang/mysql-installer-community-5.7.17.0.msi";
    	String key = "shrs@$FHF56746543FGHSJNn";
    	new EncodeFileUtil(isEncode, filename, key).run();
    }
...
class EncodeThread extends Thread {
    ...
    private EncodeFileUtil encoder;
    private int key;
    ...
    public EncodeThread(EncodeFileUtil encoder, byte key, int interval, int index) {
