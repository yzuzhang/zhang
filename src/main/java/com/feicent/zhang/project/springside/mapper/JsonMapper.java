 ...
 *******************************************************************************/
package com.feicent.zhang.project.springside.mapper;
...
public class JsonMapper {
	 ...
	 * 构造Collection类型.
	 */
	public JavaType buildCollectionType(@SuppressWarnings("rawtypes") Class<? extends Collection> collectionClass, Class<?> elementClass) {
