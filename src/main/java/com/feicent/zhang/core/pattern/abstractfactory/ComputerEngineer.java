...
public class ComputerEngineer {
    ...
    private Cpu cpu = null;//定义组装机需要的CPU
    private Mainboard mainboard = null;//定义组装机需要的主板
    ...
    public void makeComputer(AbstractFactory af){
        ...
        prepareHardwares(af);
        //2:组装机器
        System.out.println("开始组装机器...");
        //3:测试机器
        System.out.println("开始测试机器...");
        //4：交付客户
        System.out.println("交付客服一台电脑");
    }
