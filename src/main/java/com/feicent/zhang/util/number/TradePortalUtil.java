...
public class TradePortalUtil {
	...
	public static Logger logger = LoggerFactory.getLogger(TradePortalUtil.class);
    ...
    public static void main(String[] args) {
		System.out.println("生成长度30英文数字的流水账号: "+getSysJournalNo(30, false));
		System.out.println("长度为20的全数字: "+ getSysJournalNo());
		System.out.println(moneyYuanToFen("123.56")+"分钱");
		System.out.println(getStringSimple("f64ec0343a2f47eabb3a5a483ea4db"));
		
		String hello = "你好啊!";
		String encodeStr = encode(hello);
		System.out.println(hello+"---> "+encodeStr);
