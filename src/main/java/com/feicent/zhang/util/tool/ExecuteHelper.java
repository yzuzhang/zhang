 ...
 * http://ostermiller.org/utils/src/ExecHelper.java.html
 */
public final class ExecuteHelper {
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray, String[] envp) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray, envp), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray, String[] envp, File dir) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray, envp), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray, String charset) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray, String[] envp, String charset) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray, envp), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper exec(String[] cmdarray, String[] envp, File dir, String charset) throws IOException {
		return new ExecuteHelper(Runtime.getRuntime().exec(cmdarray, envp), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper execUsingShell(String command) throws IOException {
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecuteHelper execUsingShell(String command, String charset) throws IOException {
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	private ExecuteHelper(Process process, String charset) throws IOException {
