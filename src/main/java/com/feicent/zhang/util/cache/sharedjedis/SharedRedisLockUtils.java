package com.feicent.zhang.util.cache.sharedjedis;
...
public class SharedRedisLockUtils {
	...
	public static void setRedisTemplate(RedisTemplate<String, ?> redisTemplate) {
	...
	public Boolean setNX(final String key, final String jsonString){
		Boolean result =  (Boolean) SharedRedisLockUtils.redisTemplate.execute(new RedisCallback<Boolean>(){
    ...
    public String getSet(final String key, final String jsonString){
        String result =  (String) SharedRedisLockUtils.redisTemplate.execute(new RedisCallback<String>(){
